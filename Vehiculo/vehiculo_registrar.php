<div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="fas fa-edit"></span> Registrar Vehículo</h3>
			<form action="<?=base_url()?>index.php/vehiculo/insertardb" class="form-horizontal" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="marca" name="marca"  required name="titulo">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
                <input type="text" class="form-control" id="modelo" name="modelo"  required name="titulo">
				</div>
              </div>
              <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label">Color</label>
				<div class="col-sm-9">
                <input type="text" class="form-control" id="color" name="color"  required name="titulo">
				</div>
              </div>	
              <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label">placa</label>
				<div class="col-sm-9">
                <input type="text" class="form-control" id="placa" name="placa"  required name="titulo">
				</div>
              </div>	
              <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label">Año de Fabricación</label>
				<div class="col-sm-9">
                <input type="text" class="form-control" id="fabricacion" name="fabricacion"  required name="titulo">
				</div>
              </div>	
